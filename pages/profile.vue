...
<template>
  ...
  <!-- <CardBox>
    <div type="justify-around lg:justify-center">
        ...
        <div class="flow-root">
          ...
          <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="flex items-center justify-between py-4">
              ...
              >
                <input id="company-news" type="checkbox" class="sr-only" />
                <span
            ...
            <div class="flex items-center justify-between pt-4">
              ...
              <label
                ...
                class="relative flex items-center cursor-pointer"
              >
                <input id="new-messages" type="checkbox" class="sr-only" />
                <span
                  class="h-6 bg-gray-200 border border-gray-200 rounded-full w-11 toggle-bg dark:bg-gray-700 dark:border-gray-600"
                ></span>
              </label>
          ...
          <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div class="flex items-center justify-between py-4">
              ...
              <label
                ...
                class="relative flex items-center cursor-pointer"
              >
                <input id="rating-reminders" type="checkbox" class="sr-only" />
                <span
                  class="h-6 bg-gray-200 border border-gray-200 rounded-full w-11 toggle-bg dark:bg-gray-700 dark:border-gray-600"
                ></span>
              </label>
            ...
            <div class="flex items-center justify-between pt-4">
              ...
              <label
                ...
                class="relative flex items-center cursor-pointer"
              >
                <input id="buyer-rev" type="checkbox" class="sr-only" />
                <span
                  class="h-6 bg-gray-200 border border-gray-200 rounded-full w-11 toggle-bg dark:bg-gray-700 dark:border-gray-600"
                ></span>
              </label>
