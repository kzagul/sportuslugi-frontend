  ...
  <NuxtLayout name="admin">
    ...
    <div class="card">
      ...
      <Dialog
        ...
        :style="{ width: '450px' }"
        header="Изменение данных учреждения"
        :modal="true"
        class="p-fluid"
      >
        <!-- <img
      ...
      <Dialog
        ...
        :style="{ width: '450px' }"
        header="Добавить новое учреждение"
        :modal="true"
      >
...
function addProduct() {
  institutionStore.postInstitution(request?.value.name);
  addProductDialog.value = false;
  toast.add({
    severity: "success",
    summary: "Успешно",
    detail: "Новое учреждения добавлено",
    life: 3000,
  });
}
...
function updateProduct() {
  ...
  toast.add({
    severity: "success",
    summary: "Успешно",
    detail: "Данные учреждения обновлены",
    life: 3000,
  });
}
...
function deleteProduct() {
  ...
  institutionStore.deleteInstitutionByID(selectedProduct?.value.id);
  selectedProduct.value = null;
  toast.add({
    severity: "success",
    summary: "Успешно",
    detail: "Учреждение удалено",
    life: 3000,
  });
}
